  ...
  <div>
    ...
    <div class="filter">
      <div @click="(show1 = !show1)" class="sidebar__collapse btn">
        <div :class="{ 'sidebar__collapse-icon unrotated': show1, 'sidebar__collapse-icon rotated': !show1 }">
          <span class="icon-caret-down px20"></span>
        </div>
        <div class="sidebar__collapse-header">
    ...
    <div class="filter">
      <div @click="(show2 = !show2)" class="sidebar__collapse btn">
        <div :class="{ 'sidebar__collapse-icon unrotated': show2, 'sidebar__collapse-icon rotated': !show2 }">
          <span class="icon-caret-down px20"></span>
        </div>
        <div class="sidebar__collapse-header">
    ...
    <div class="filter">
      <div @click="(show3 = !show3)" class="sidebar__collapse btn">
        <div :class="{ 'sidebar__collapse-icon unrotated': show3, 'sidebar__collapse-icon rotated': !show3 }">
          <span class="icon-caret-down px20"></span>
        </div>
        <div class="sidebar__collapse-header">
