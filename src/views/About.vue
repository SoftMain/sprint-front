  ...
  <div class="container">
    <div class="about__our-project">
      <div class="about__our-project-text">
        ...
        <p class="text-lg">
          Каталог SoftMain разработан с целью информирования общественности и
          потенциальных потребителей о российских программных продуктах. Данные
          о продуктах взяты из Единого Реестра Отечественного ПО, а также
          разработчиков продуктов. <br />На нашем сайте вы можете подобрать
          продукт для личного и коммерческого использования с помощью фильтров,
          а также ознакомиться со списком компаний-системных интеграторов,
    ...
    <div class="container">
      <ul class="about__label-card">
        <li class="about__label-item">
          ...
          <div class="text-lg">Добавленных продуктов</div>
        </li>
        <li class="about__label-item">
          <h2 class="font-medium">16</h2>
          <div class="text-lg">Категорий ПО</div>
        </li>
        <li class="about__label-item">
          <h2 class="font-medium">30</h2>
          <div class="text-lg">Разработчиков</div>
        </li>
      </ul>
    </div>
  </div>
  ...
  <div class="container">
    <div class="about__history">
      <div class="about__history-text">
        ...
        <p class="text-lg">
          С марта 2022 года наблюдается отток иностранных продуктов с
          российского ИТ-рынка и возникают сложности с оплатой доступа к этим
          продуктам. Для пользователей, у которых возникла потребность в поиске
          и использовании отечественного ПО. «SoftMain» является информационным
          сервисом, на котором собрана подробная и структурированная информация
          о российских программах. <br />В 2022 году, на курсе 1TSprint
          собрались 20 замечательных ребят вместе, чтобы ответить на один
          единственный вопрос. “Почему легче найти достоверную информацию о
          гостиничном номере, чем о программном обеспечении в России?”. Решение,
          которое они нашли? Вы!
        </p>
      </div>
