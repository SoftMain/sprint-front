<template>
        <div class="container">
            <div class="hero proto_block">
                ...
                <div class="hero__image"><img src="/img/Integrators image/integrators_hero.png" alt=""></div>
            </div>
        </div>
        <div class="integrators proto_block">
            ...
            <div class="integrator__block_cards">
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/softline.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">SOFTLINE</h5>
                        <a title="Softline" target="_blank" class="integrators_link" href="https://softline.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Доброфлот, Росводоканал</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/lanit.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">Ланит</h5>
                        <a title="Lanit" target="_blank" class="integrators_link" href="https://www.lanit.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Куратье, Росгидромет</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/krok.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">КРОК</h5>
                        <a title="Krok" target="_blank" class="integrators_link" href="https://www.croc.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Ингосстрах, ДИТ Москвы</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/galacticka.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">Корпорация Галактика</h5>
                        <a title="Galaxy" target="_blank" class="integrators_link" href="https://galaktika.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Росатом, Роснефть</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/itglobal.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">ITGLOBAL.COM</h5>
                        <a title="itglobal" target="_blank" class="integrators_link" href="https://itglobal.com/ru-ru/?utm_source=yandex&utm_medium=cpc&utm_campaign=78611660&utm_content=12795071372_12795071372_type1_41196795826_41196795826_desktop_5036446149_it%20global_0_1_premium_none_search_Новосибирск&utm_term=it%20global&roistat=direct2_search_12795071372_it%20global&roistat_referrer=none&roistat_pos=premium_1&etext&yclid=7074774208870156308"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Сеть АЗС «Опти», Digital Attitude</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/aiteko.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">АЙТЕКО</h5>
                        <a title="iteko" target="_blank" class="integrators_link" href="https://www.i-teco.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">Райффайзенбанк, Москоллектор</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/otr.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">OTP</h5>
                        <a title="otr" target="_blank" class="integrators_link" href="https://otr.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
                    <div class="integrator__block_cards_elem_text"><p class="text-base">ПФР, МинФин, Альфа-Банк, Ренессанс</p></div>
                </div>
                <div class="integrator__block_cards_elem">
                    <div class="integrator__block_cards_elem_image"><img src="/img/Integrators image/korus.png" alt=""></div>
                    <div class="integrator__block_cards_elem_header">
                        <h5 class="font-regular">КОРУС Консалтинг</h5>
                        <a title="korus" target="_blank" class="integrators_link" href="https://korusconsulting.ru/"><img src="/img/Integrators image/link img.png" alt=""></a>
                    </div>
